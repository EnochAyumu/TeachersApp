...
if(isset($_POST['btn-signup']))
{
  ...
  if($count==0){
		...
		$query = "INSERT INTO department(user_name,staff_id,user_pass,user_department) VALUES('$uname','$staff_id','$new_password','$user_department')";

		
		if($MySQLi_CON->query($query))
		{
			$msg = "<div class='alert alert-success'>
						<span class='glyphicon glyphicon-info-sign'></span> &nbsp; successfully created Department !
					</div>";
		}
		else
		{
			$msg = "<div class='alert alert-danger'>
						<span class='glyphicon glyphicon-info-sign'></span> &nbsp; error while creating Department !
					</div>";
		}
	}
  else{
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="#">New Department</a></li>
          </ul>
...
<div class="signin-form">
	...
	<div class="container">
       ...
       <form class="form-signin" method="post" id="register-form">
        ...
        <h2 class="form-signin-heading">New Department</h2><hr />
      ...
      <div class="form-group">
       ...
       <fieldset class="form-group">
        ...
        <div class="form-group">
            <button type="get" class="btn btn-default" name="btn-signup">
